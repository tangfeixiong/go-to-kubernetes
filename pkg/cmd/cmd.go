...
func NewC3Command(f *cmdutil.Factory, in io.Reader, out, err io.Writer) *cobra.Command {
	cmds := &cobra.Command{
		Use:   "c3",
		Short: "c3 extend to controls the Kubernetes cluster manager",
		Long: `c3 extend to controls the Kubernetes cluster manager.
...
Find more information at https://github.com/kubernetes/kubernetes.`,
	...
	cmds.AddCommand(NewCmdServiceAutoDiscovery(f, out))
	cmds.AddCommand(NewCmdExportIntoChart(f, out))
	cmds.AddCommand(NewCmdCreateFromChart(f, out, helm.Interface(nil)))
