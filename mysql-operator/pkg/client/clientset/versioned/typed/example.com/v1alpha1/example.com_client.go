...
import (
	...
	"github.com/tangfeixiong/go-to-kubernetes/mysql-operator/pkg/client/clientset/versioned/scheme"
...
func (c *ExampleV1alpha1Client) Mariadbs(namespace string) MariadbInterface {
	return newMariadbs(c, namespace)
}

func (c *ExampleV1alpha1Client) Mysqls(namespace string) MysqlInterface {
